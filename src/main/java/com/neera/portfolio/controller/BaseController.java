package com.neera.portfolio.controller;

import com.neera.portfolio.entity.*;
import com.neera.portfolio.service.interfaces.*;
...
public class BaseController {
    ...
    private void getSkillAttributes(Model theModel){
        List<Skill> languages = skillService.getSkillsByCategory("Frontend Technologies");
        List<Skill> frameworks = skillService.getSkillsByCategory("Backend & Frameworks");
        List<Skill> devOpsTools = skillService.getSkillsByCategory("Tools & Platforms");
